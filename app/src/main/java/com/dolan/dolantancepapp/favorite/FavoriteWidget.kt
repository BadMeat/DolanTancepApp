...
class FavoriteWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val TOAST_ACTION = "com.dolan.dolantancepapp.favorite.TOAST_ACTION"
        const val EXTRA_ITEM = "com.dolan.dolantancepapp.favorite.EXTRA_ITEM"
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (intent?.action != null) {
            if (intent.action.equals(TOAST_ACTION, true)) {
